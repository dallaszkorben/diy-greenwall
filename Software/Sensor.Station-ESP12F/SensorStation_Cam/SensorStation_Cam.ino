...
void loop() {
  ...
  String webserver_path_reg_picture = "cam/add/camId/5/timestamp/2022.03.06T18:24:44";
  ...
  //http.addHeader("enctype", "multipart/form-data");

  String httpRequestData = "{";
  httpRequestData.concat("\"image\":\"");
//  httpRequestData.concat(buffer);
