...
bool loadConfig(){
  ...
  webserver_path_pump_register = String(doc["central-ap"]["webserver-path-pump-register"]);
  ...
  pump_id = String(doc["control-sta"]["pump-id"]);
  pump_gpio = doc["control-sta"]["pump-gpio"];
  ...
  Serial.print("control-sta.pump-id = ");
